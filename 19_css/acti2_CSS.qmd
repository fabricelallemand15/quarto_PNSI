...
1. Ouvrir l'activité [Capytale correspondant à cette partie](https://capytale2.ac-paris.fr/web/c/5db1-2973229).
...
Dans cette partie, vous allez reprendre la page Web créée lors de l'activité sur le langage HTML et créer une feuille de style afin de la mettre en forme. Quand vous serez satisfait du résultat, enregistrer votre travail dans l'activité [Capytale prévue à cet effet](https://capytale2.ac-paris.fr/web/c/ac8e-2973231). -->