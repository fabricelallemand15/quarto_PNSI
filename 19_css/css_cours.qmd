---
title: Cours (2) - Introduction au CSS
---

<!-- Introduction avec historique -->

![logo CSS](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/CSS3_logo_and_wordmark.svg/langfr-800px-CSS3_logo_and_wordmark.svg.png){width="15%"}
...
![modèle de boîtes](box-model-devtools.png)
...
![outils de développement](devtools.png){width="70%"}
