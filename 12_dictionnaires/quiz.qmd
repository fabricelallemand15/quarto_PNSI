---
title: Quiz (tableaux, p-uplets et dictionnaires)
format: live-html
---

_Les exercices précédés du symbole {{< fa desktop >}} sont à faire directement sur cette page._
...
def moyenne(tab: list) -> float:
    """Retourne la moyenne des notes contenues dans le tableau
    tab: tableau de dictionnaires contenant les notes des élèves"""
    # votre code ici


# Tester la fonction ci-dessous

print(moyenne([{'nom':'Titi', 'note':12}, {'nom':'Tutu', 'note':11}, {'nom':'Toto', 'note':17}]))
````
