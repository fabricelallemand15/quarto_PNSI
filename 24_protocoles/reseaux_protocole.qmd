...
Ce cours est basé sur le cours de @lassus_premiere.
...
Vous pouvez télécharger le fichier [ping_switch.fls](ping_switch.fls).
...
Vous pouvez télécharger le fichier [ping_routeur.fls](ping_routeur.fls).
