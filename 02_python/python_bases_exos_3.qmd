...
### {{< fa desktop >}}  Exercice 10

_Dans cet exercice, répondre à chaque question en écrivant un programme utilisant une boucle `for`, puis un programme utilisant une boucle `while`._
...
### {{< fa solid pencil-alt >}} Exercice 13
