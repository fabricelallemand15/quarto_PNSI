---
title: Exercices - Fonctions et portée des variables
---
...
1. Écrire une **fonction** `prixTTC` qui calcule un prix TVA comprise (au taux de 20 %) en fonction du prix hors taxes.
...
## {{< fa solid pencil-alt >}} {{< fa desktop >}}  Exercice 4
