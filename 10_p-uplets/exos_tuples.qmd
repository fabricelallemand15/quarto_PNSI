---
title: "Exercices (p-uplets)"
---

**Lien vers Capytale pour faire les exercices en ligne :** [Capytale](https://capytale2.ac-paris.fr/web/c/f61e-2534118)
...
2.	Écrire une fonction qui prend en paramètre le tableau ``ListeAdherents``, qui affiche la liste des avatars de tous les adhérents, et qui renvoie l'âge moyen de tous les adhérents (utiliser une boucle for).
