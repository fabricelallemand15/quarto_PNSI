---
title: "5.3 - Traitements de données en tables"
execute: 
  cache: true
---
...
Avec quelques exercices à faire en ligne : [Cliquer ici](https://capytale2.ac-paris.fr/web/c/eb73-3484435)
:::
...
2. Projeter pour construire la liste des noms puis celle des paires de notes d'info et de maths :
...
On souhaite trier en fonction du langage dans l'ordre alphabétique, puis de la note dans l'ordre croissant. La fonction donnée en argument ``key`` doit alors retourner le couple ordonné des deux attributs voulus :
