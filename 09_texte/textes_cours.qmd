---
title: Cours (4) - Textes et encodage des caractères
---
...
Le site [symbl.cc](https://symbl.cc/en/unicode/table/){target="_blank"} liste tous les caractères de la table Unicode.
