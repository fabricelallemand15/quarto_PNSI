---
title: "Cours (3) - Introduction au JavaScript"
---

<!-- Introduction avec historique -->

![](https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/1024px-Unofficial_JavaScript_logo_2.svg.png){width=15%}
...
Du point de vue de JavaScript, la page web est un arbre HTML (voir [le cours précédent](../18_html/html_cours.qmd)).
