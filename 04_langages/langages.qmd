...
Dans le script ci-dessous, écrit en C, on retrouve le même algorithme. Le code fonctionne en C ou en C++ (on peut considérer que C est un sous-ensemble de C++). [(Fichier complet à télécharger pour tester)](primes.cpp){target="_blank"} :
...
La même chose en C# [(fichier complet à télécharger pour tester)](primes.cs){target="_blank"} :
...
Passons à Java [(fichier complet à télécharger pour tester)](primes.java){target="_blank"} :
...
Voici maintenant un peu de Javascript [(fichier complet à télécharger pour tester)](primes.js){target="_blank"} :
...
En Basic (version visual Basic) [(fichier complet à télécharger pour tester)](primes.vb){target="_blank"} :

````{.vbscript filename="Langage Visual Basic"}
Function is_prime(n)
    If n = 2 Then
        is_prime = True
...
En Fortran [(fichier complet à télécharger pour tester)](primes.f90){target="_blank"} :
...
En Pascal [(fichier complet à télécharger pour tester)](primes.pas){target="_blank"} :
...
Pour finir, en OCaml [(fichier complet à télécharger pour tester)](primes.ml){target="_blank"} :
...
* La page Wikipedia ["Hello, World!" program](https://en.wikipedia.org/wiki/%22Hello,_World!%22_program){target="_blank"} présente le fameux programme affichant la phrase "Hello, World!" à l'écran dans de très nombreux langages de programmation.