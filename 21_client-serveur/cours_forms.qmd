...
Comme nous l'avons vu dans [l'activité](acti4_forms.qmd){target="_blank"}, les attributs **action** et **method** de l'élément **`<form>`** définissent le fonctionnement du formulaire :
...
![](fonctionnement-php-client-serveur.png)
