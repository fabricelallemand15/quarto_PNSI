...
## {{< fa desktop >}} Exercice 1 : Utilisation des outils de développement du navigateur

Avec un navigateur Web, demander la page  d'adresse [https://nsi.sitelf.fr/divers/mapageweb.html](https://nsi.sitelf.fr/divers/mapageweb.html). Ouvrir la fenêtre d'outils de développement en appuyant sur la touche de fonction `F12` et sélectionner l'onglet Réseau. On peut voir les entêtes de la requête et de la réponse HTTP. On s'intéresse ici à la requête concernant la page HTML elle-même.
...
1. Effectuer une nouvelle requête avec l'URL [https://nsi.sitelf.fr/Divers/mapageweb.html](https://nsi.sitelf.fr/Divers/mapageweb.html). Quel est le code d'état de la réponse ? Explication ?
1. Effectuer une nouvelle requête avec l'URL [https://nsi.sitelf.fr/divers/interdit/](https://nsi.sitelf.fr/divers/interdit/). Quel est le code d'état de la réponse ? Explication ?

## {{< fa desktop >}} Exercice 2 : HTTP et python
