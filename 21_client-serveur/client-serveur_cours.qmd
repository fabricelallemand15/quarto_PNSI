---
title: "Cours (4) - Le protocole HTTP et l'architecture client-serveur"
---

![logo HTTP](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/HTTP_logo.svg/640px-HTTP_logo.svg.png){width="15%"}
...
![Architecture client - serveur](https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/Mod%C3%A8le-client-serveur.svg/1920px-Mod%C3%A8le-client-serveur.svg.png){width="50%"}
...
![Requête HTTP](requete.png){width="50%"}
...
Considérons la page web `mapageweb.html` suivante, hébergée en ligne [à cette adresse](https://sitelf.fr/divers/mapageweb.html){target="_blank"}. : 
...
![réponse HTTP](reponse.png){width="50%"}
...
Dans l'exemple du chargement de la page `mapageweb.html` suivante, hébergée en ligne [à cette adresse](https://sitelf.fr/divers/mapageweb.html){target="_blank"}, voici la réponse du serveur :
