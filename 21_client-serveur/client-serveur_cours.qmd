...
![Requête HTTP](https://developer.mozilla.org/en-US/docs/Web/HTTP/Overview/http_request.png){width="50%"}
...
Considérons la page web `mapageweb.html` suivante, hébergée en ligne [à cette adresse](https://flallemand.fr/divers/mapageweb.html){target="_blank"}. : 
...
Dans l'exemple du chargement de la page `mapageweb.html` suivante, hébergée en ligne [à cette adresse](https://flallemand.fr/divers/mapageweb.html){target="_blank"}, voici la réponse du serveur :
