---
title: Cours (3) - Nombres flottants
---
...
Morale : {{< fa triangle-exclamation >}} {{< fa triangle-exclamation >}} {{< fa triangle-exclamation >}} **On évitera toujours de comparer des flottants en Python.** {{< fa triangle-exclamation >}} {{< fa triangle-exclamation >}} {{< fa triangle-exclamation >}}
:::
...
![](IEEE754_simple_precision.png){width=100%}
:::
