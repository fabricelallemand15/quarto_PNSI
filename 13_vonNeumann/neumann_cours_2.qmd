---
title: "Cours : Partie 2 - Du transistor aux circuits logiques"
---
...
un transistor : ![](transistor_3.jpg){width=20%}

un tube électronique : ![](tube_eniac.jpeg){width=20%}
...
un circuit intégré : ![](circuit_integre.JPG){width=20%}
...
Pour en savoir plus sur les transistors voir [cet article](https://mathsinfolycee.sitelf.fr/posts/transistors/index.html).
...
Pour en savoir plus sur les portes logiques voir la vidéo "Les portes logiques" dans cet [article](https://mathsinfolycee.sitelf.fr/posts/codeurpro/).