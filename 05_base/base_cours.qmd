---
title: "Cours (1) - Entiers naturels"
---
...
Voir [cet article du blog](https://mathsinfolycee.fr/posts/mesurerinfo/index.html){ target=_blank } au sujet des unités de mesures binaires.
...
$1101\; 0011_2 = 1\times 2^7 + 1\times 2^6 + 0\times 2^5 + 1\times 2^4 + 0\times 2^3 + 0\times 2^2 + 1\times 2^1 + 1\times 2^0 = 211_{10}$.
...
En complément, vous pouvez regarder la vidéo "Le binaire, c'est quoi ?" dans cet [article](https://mathsinfolycee.fr/posts/codeurpro/).