...
Voir [cet article du blog](https://mathsinfolycee.sitelf.fr/posts/mesurerinfo/index.html){ target=_blank } au sujet des unités de mesures binaires.
...
En complément, vous pouvez regarder la vidéo "Le binaire, c'est quoi ?" dans cet [article](https://mathsinfolycee.sitelf.fr/posts/codeurpro/).