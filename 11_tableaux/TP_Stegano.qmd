...
* Le travail pourra être fait dans Thonny, ou dans la console Python accessible dans le menu ci-dessus. Dans ce cas, les images devront être chargées dans la console en utilisant le bouton représentant un dossier.
:::
...
Complète ci-dessous la fonction `crypte` réalisant la première tâche
demandée :
...
Complète ci-dessous la fonction `decrypte` réalisant la seconde tâche
demandée :
