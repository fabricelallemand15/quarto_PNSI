...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, toprule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Principe de l'algorithme}, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, left=2mm, opacityback=0, rightrule=.15mm, toptitle=1mm, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, coltitle=black, bottomtitle=1mm, arc=.35mm]
