...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, breakable, titlerule=0mm, opacityback=0, coltitle=black, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Principe de l'algorithme}, arc=.35mm, toprule=.15mm, colback=white, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, left=2mm]
