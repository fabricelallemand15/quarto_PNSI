...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, colback=white, leftrule=.75mm, rightrule=.15mm, breakable, bottomtitle=1mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Principe de l'algorithme}, arc=.35mm, bottomrule=.15mm, left=2mm, titlerule=0mm, coltitle=black]
